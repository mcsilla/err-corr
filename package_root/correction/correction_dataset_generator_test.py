...
test_data_correction_gen = (
    ...
    ("Szerecsenként r", ["S", "##z", "##e", "##r", "##e", "##c", "##s", "##e", "##n", "[PAD]", "##k", "##é", "##n", "##t", "r"]),
    ("jövőbeli k", ["j", "##ö", "##v", "##ő", "[PAD]", "##b", "##e", "##l", "##i", "k"]),
    ...
    ("el a", ["e", "##l", "a"]),
    ("önkéntes", ["ö", "##n", "##k", "##é", "##n", "##t", "##e", "##s"]),
    ("ez nem a", ["e", "##z", "[PAD]", "n", "##e", "##m", "a"]),
)

test_data_old_gen = (
    ("Össze", ["Ö", "##f", "##z", "##f", "##z", "##e"]),
    ("csipet és a cs", ["t", "##s", "##i", "##p", "##e", "##t", "'", "s", "a", "'", "t", "##s"]),
    ("Szerecsenként r", ["F", "##z", "##e", "##r", "##e", "##t", "##s", "##e", "##n", "-", "k", "##é", "##n", "##t", "r"]),
    ("jövőbeli k", ["j", "##ö", "##v", "##ő", "-", "b", "##é", "##l", "##i", "k"]),
